...
class GridDestinationAdapter(private val listDestination: ArrayList<Destination>) :
    RecyclerView.Adapter<GridDestinationAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_row_destination_grid, parent, false)
